...
import { scaleOrdinal, scaleBand, scaleLinear, scaleSqrt } from 'd3-scale';
...
const d3 = {
  select, selectAll, mouse, format, csv, path, scaleOrdinal, transition,
  nest, scaleBand, scaleLinear, scaleSqrt, axisLeft, axisBottom, max, min, extent,
  forceSimulation, forceX, forceY, forceCollide, drag
};
...
export default class DistributionSlider extends React.Component{
  constructor(){
    super();
    this.state = {
        rangeSliderData : '',
