...
const part6 = (
  <div className='desc' id='descLast'>
    From this data, we were able to analyze the differences in the total number of candidates with identified races before and after RCV was implemented. In San Leandro, there were a total of about 7 Asian American, African American, and Latino candidates from 2000 - 2008 (pre-RCV), while there were a total of 12  Asian American, African American, and Latino candidates from 2010 - 2014 (post-RCV). In San Francisco, there were a total of about 85 Asian American, African American, and Latino candidates from 1992 - 2003 (pre-RCV) and 119 from 2004 - 2014 (post-RCV). In Oakland, there were a total of about 60 Asian American, African American, and Latino candidates from 2000 - 2008 (pre-RCV), while there were a total of 53 from 2010 - 2014 (post-RCV). In Berkeley, there were a total of about 9 Asian American, African American, and Latino candidates from 2000 - 2008 (pre-RCV), while there were a total of 8 from 2010 - 2014 (post-RCV).
  </div>
